...
final class VideoPlayer {
    ...
    static class CacheDataSourceFactory implements DataSource.Factory {
        ...
        public DataSource createDataSource() {
            ...
            DatabaseProvider databaseProvider = new ExoDatabaseProvider(this.context);

            if (sDownloadCache == null) {
                sDownloadCache = new SimpleCache(new File(context.getCacheDir(), "media"), evictor, databaseProvider);
            }
